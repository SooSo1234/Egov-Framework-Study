...
@Service("codeService")
public class CodeServiceImple extends EgovAbstractServiceImpl implements CodeService{
	...
	@Override
	public int updateCodesModify(CodeVO vo) throws Exception {
		return codeDAO.updateCodesModify(vo);
	}
